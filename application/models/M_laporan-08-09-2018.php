...
function show_rekap_asessor(){
  $this->db->select('bkd_subkegiatan.nip,tb_pegawai.nama_peg,
                     ROUND(SUM(CASE WHEN bkd_subkegiatan.id_bkd = 1 THEN bkd_subkegiatan.sks_subkegiatan END),2) AS Pendidikan,
                     ROUND(SUM(CASE WHEN bkd_subkegiatan.id_bkd = 2 THEN bkd_subkegiatan.sks_subkegiatan END),2) AS Penelitian,
                     ROUND(SUM(CASE WHEN bkd_subkegiatan.id_bkd = 3 THEN bkd_subkegiatan.sks_subkegiatan END),2) AS Pengabdian,
                     ROUND(SUM(CASE WHEN bkd_subkegiatan.id_bkd = 4 THEN bkd_subkegiatan.sks_subkegiatan END),2) AS Penunjang,
                     ROUND(SUM(bkd_subkegiatan.poin_subkegiatan),2) AS Points');
  $this->db->from('bkd_subkegiatan');
  $this->db->join('tb_pegawai','bkd_subkegiatan.nip = tb_pegawai.nip');
  $this->db->where('bkd_subkegiatan.app_assesor1', 1);
  $this->db->where('bkd_subkegiatan.app_assesor2', 1);
  $this->db->group_by('bkd_subkegiatan.nip');
