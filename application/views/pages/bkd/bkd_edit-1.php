                    ...
                    <form class="form form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>MasterBkd/UpdateBkd" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                         ...
                         <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             <input type="text" value="<?php echo $pr->periode.' - '.$pr->ket_periode; ?>" readonly class="form-control col-md-7 col-xs-12">
                         </div>
                       </div>
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">SKS<span class="required">*</span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="jumlah_sks" id="jumlah_sks" class="form-control col-md-7 col-xs-12" value="<?php echo $key->jumlah_sks; ?>">
                            </div>
                        </div>
