                ...
                <div class="col-sm-12 col-md-12">
                  <div class="x_panel">
                    <div class="x_title">
                      ...
                      <!-- <b>Silahkan Klik RBKD yang ingin dilaporkan</b> -->
                                ...
                                <?php $no=1; foreach($listrbkd as $option){ ?>
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      echo anchor('RencanaKerja/EditLaporan/'.$option->id_subkegiatan,'<span class="text text-primary"><i class="glyphicon glyphicon-arrow-right"></i></span>',$attr);
                                      ?>
                                    </td>
                                  </tr>
                                <?php } ?>
                  ...
                  <div class="x_content">
                    <div class="form-group">
                        <table class="table myTable ">
                          ...
                          <tbody>
                              <?php $no=1; foreach($listlaporan as $option){ ?>
                                <tr>
                                  <th scope="row"><?php echo $no++; ?></th>
                                  <td><?php echo $option->kegiatan; ?></td>
                                </tr>
