<div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h4>Laporan Yang Disetujui Oleh Asessor 1 dan Assesor 2</h4>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form form-horizontal" role="form" method="GET" action="<?php echo base_url(); ?>History/RekapBkdAssesor1dan2">
                      <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                            <select id="fak" name="fak" class="form-control">
