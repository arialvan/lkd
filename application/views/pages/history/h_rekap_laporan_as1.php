<div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h4>Laporan Yang Disetujui Oleh Asessor 1</h4>
                    <a class="btn btn-md btn-danger" href="javascript:void(0);" onclick="javascript:introJs().start();">Baca Petunjuk</a>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form form-horizontal" role="form" method="GET" action="<?php echo base_url(); ?>History/RekapLaporanAssesor1">
                      <div class="form-group" data-step="1" data-intro="Ini adalah menu filter untuk melihat data berdasarkan Periode, Fakultas dan Kategori Dosen">
                          <label class="control-label col-md-1 col-sm-1 col-xs-12" for="last-name">Filter<span class="required"></span></label>
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <select id="id_periode" name="id_periode" class="form-control" required="required" data-step="2" data-intro="Menampilkan semua laporan. Pilih Periode dan tekan tombol Cari">
                                <option value="">Periode (Tidak boleh kosong)</option>
                                <?php foreach($per as $p){ ?>
                                <option value="<?php echo $p->id_periode; ?>"><?php echo $p->periode.'-'.$p->ket_periode; ?></option>
                                <?php } ?>
                            </select>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                            <select id="fak" name="fak" class="form-control" data-step="3" data-intro="Pilih Periode, Pilih Fakultas dan tekan tombol Cari">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12">
                            <select id="kat" name="kat" class="form-control" data-step="4" data-intro="Pilih Periode, Pilih Kategori Dosen dan tekan tombol Cari">
                          ...
                          <div class="col-md-2 col-sm-2 col-xs-12">
                            <button type="submit" class="btn btn-success" data-step="5" data-intro="Setelah Filter dipilih, tekan tombol Cari">Cari</button>
                          </div>
                      </div>
                      <div class="ln_solid"></div>
                    </form>
                    <div data-step="7" data-intro="Download Laporan Excel" ></div>
                    <table class="table table-striped table-bordered myTable display nowrap" style="width:100%" data-step="6" data-intro="Hasil Laporan">
                      <thead>
                        <tr>
