                    ...
                    <table class="table table-striped table-bordered myTable display nowrap" style="width:100%">
                      ...
                      <tbody>
                        ...
                        foreach($pendidikan as $dt){
                          ...
                          $kegiatans   = wordwrap($dt->kegiatan, 65, "<br />\n");
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                                echo anchor('AdminFakultas/LaporanApproved_1/'.$dt->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                echo anchor('AdminFakultas/LaporanApproved_2/'.$dt->id_subkegiatan."-".$this->uri->segment(3)."-"."2",'<span class="btn btn-sm btn-danger">Tolak</span>');
                                echo '<br /><br />';
                                if($dt->app_assesor1==1){echo 'Assesor 1 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 1 <span class="glyphicon glyphicon-remove"></span><br />';}
                                if($dt->app_assesor2==1){echo 'Assesor 2 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 2 <span class="glyphicon glyphicon-remove"></span><br />';}
                            ?>
                          </td>
                        </tr>
                        <?php } ?>
                    ...
                    <table class="table table-striped table-bordered myTable display nowrap" style="width:100%">
                      ...
                      <tbody>
                        ...
                        foreach($penelitian as $dt1){
                          ...
                          $kegiatans   = wordwrap($dt1->kegiatan, 65, "<br />\n");
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                                echo anchor('AdminFakultas/LaporanApproved_1/'.$dt1->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                echo anchor('AdminFakultas/LaporanApproved_2/'.$dt1->id_subkegiatan."-".$this->uri->segment(3)."-"."2",'<span class="btn btn-sm btn-danger">Tolak</span>');
                                echo '<br /><br />';
                                if($dt1->app_assesor1==1){echo 'Assesor 1 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 1 <span class="glyphicon glyphicon-remove"></span><br />';}
                                if($dt1->app_assesor2==1){echo 'Assesor 2 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 2 <span class="glyphicon glyphicon-remove"></span><br />';}
                            ?>
                          </td>
                        </tr>
                        <?php } ?>
                    ...
                    <table class="table table-striped table-bordered myTable display nowrap" style="width:100%">
                      ...
                      <tbody>
                        ...
                        foreach($pengabdian as $dt2){
                          ...
                          $kegiatans   = wordwrap($dt2->kegiatan, 65, "<br />\n");
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                                echo anchor('AdminFakultas/LaporanApproved_1/'.$dt2->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                echo anchor('AdminFakultas/LaporanApproved_2/'.$dt2->id_subkegiatan."-".$this->uri->segment(3)."-"."2",'<span class="btn btn-sm btn-danger">Tolak</span>');
                                echo '<br /><br />';
                                if($dt2->app_assesor1==1){echo 'Assesor 1 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 1 <span class="glyphicon glyphicon-remove"></span><br />';}
                                if($dt2->app_assesor2==1){echo 'Assesor 2 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 2 <span class="glyphicon glyphicon-remove"></span><br />';}
                            ?>
                          </td>
                        </tr>
                        <?php } ?>
                    ...
                    <table class="table table-striped table-bordered myTable display nowrap" style="width:100%">
                      ...
                      <tbody>
                        ...
                        foreach($penunjang as $dt3){
                          $total2[]=$dt3->sks_subkegiatan;
                          $poin2[]=$dt3->poin_subkegiatan;
                          $kegiatans   = wordwrap($dt3->kegiatan, 65, "<br />\n");
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                                echo anchor('AdminFakultas/LaporanApproved_1/'.$dt3->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                echo anchor('AdminFakultas/LaporanApproved_2/'.$dt3->id_subkegiatan."-".$this->uri->segment(3)."-"."2",'<span class="btn btn-sm btn-danger">Tolak</span>');
                                echo '<br /><br />';
                                if($dt3->app_assesor1==1){echo 'Assesor 1 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 1 <span class="glyphicon glyphicon-remove"></span><br />';}
                                if($dt3->app_assesor2==1){echo 'Assesor 2 <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor 2 <span class="glyphicon glyphicon-remove"></span><br />';}
                            ?>
                          </td>
                        </tr>
                        <?php } ?>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-pendidikan" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>AdminFakultas/UpdateRencana">
              ...
              <input type="hidden" class="form-control" id="uri" name="uri" value="<?php echo $this->uri->segment(3); ?>"/>
