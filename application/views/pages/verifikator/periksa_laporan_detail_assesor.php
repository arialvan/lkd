          ...
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="alert alert-success fade in">
                ...
                <fieldset>
                  <legend></legend>
                    <a class="btn btn-lg btn-danger" href="javascript:void(0);" onclick="javascript:introJs().start();">BACA Petunjuk Pemeriksaan</a>
                </fieldset>
        </div>
        <br /><br />
                            ...
                            <table class="table table-striped table-bordered myTable display nowrap" style="width:100%">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td data-step="3" data-intro="Periksa file laporan pada kolom ini.">
                        ...
                        <div class="x_panel">
                          ...
                          <div class="x_content">
                            <?php
                              ...
                              if($ca->assesor_1==$this->session->userdata('nipp') && $ca->p_assesor1==0){
                            ?>
                              <h4>Silahkan tekan tombol di bawah apabila anda telah memeriksa seluruh laporan.</h4>
                              <a href="<?php echo base_url(); ?>Verifikator/AssesorSelesaiMemeriksa/<?php echo $this->uri->segment(3); ?>" class="btn btn-lg btn-danger" onclick="return confirm('Apakah anda sudah selesai memeriksa seluruh laporan ?')" >Selesai Memeriksa Laporan</a>
                            <?php
                          }elseif($ca->assesor_2==$this->session->userdata('nipp') && $ca->p_assesor2==0){
                            ?>
                              <h4>Silahkan tekan tombol di bawah apabila anda telah memeriksa seluruh laporan.</h4>
                              <a href="<?php echo base_url(); ?>Verifikator/AssesorSelesaiMemeriksa/<?php echo $this->uri->segment(3); ?>" class="btn btn-lg btn-danger" onclick="return confirm('Apakah anda sudah selesai memeriksa seluruh laporan ?')" >Selesai Memeriksa Laporan</a>
                            <?php
                            ...
                            ?>
                            <a href="<?php echo base_url(); ?>Verifikator/PeriksaLaporan" class="btn btn-lg btn-danger" onclick="return confirm('Apakah anda sudah selesai memeriksa seluruh laporan ?')" >Selesai Memeriksa Laporan</a>
                          <?php } ?>
                          </div>
                        </div>
                      </div>
