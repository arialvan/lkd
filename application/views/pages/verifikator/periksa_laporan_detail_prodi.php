                            ...
                            <table class="table table-striped table-bordered myTable display nowrap" style="width:100%">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td data-step="4" data-intro="Terima dan Tolak Laporan">
                                      <?php
                                        ...
                                        //Jika assesor 1 belum periksa dan assesor 2 != menolak dan laporan sudah upload
                                          if($fl->ketua_prodi==$this->session->userdata('nipp') && $dt->lapor_sebagai_bkd==0 && $dt->applaporan_ketuaprodi==0){ ?>
                                              <a href="javascript:;"
                                              ...
                                              <?php
                                                  echo anchor('Verifikator/LaporanApproved_Kaprodi/'.$dt->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                                  echo '<br />'.wordwrap($dt->komentar, 75, "<br />\n");
                                          //Jika assesor 2 belum periksa dan assesor 1 != menolak dan laporan sudah upload
                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt->lapor_sebagai_bkd==0 && $dt->applaporan_ketuaprodi==2){
                                                    echo $this->pustaka->StatusPemeriksaan($dt->applaporan_ketuaprodi,$dt->app_assesor1,$dt->app_assesor2);

                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt->lapor_sebagai_bkd==0 && $dt->applaporan_ketuaprodi==1){
                                                    echo $this->pustaka->StatusPemeriksaan($dt->applaporan_ketuaprodi,$dt->app_assesor1,$dt->app_assesor2);
                                  ...
                                  <td>
                                    <?php
                                          if($dt->applaporan_ketuaprodi==1 && $dt->lapor_sebagai_bkd==0){echo 'Ketua Prodi <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Ketua Prodi <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt->app_assesor1==1 && $dt->lapor_sebagai_bkd==1){echo 'Assesor I <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor I <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt->app_assesor2==1 && $dt->lapor_sebagai_bkd==1){echo 'Assesor II <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor II <span class="glyphicon glyphicon-remove"></span><br />';}
                                    ?>
                                  </td>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <?php
                                        foreach($filter as $fl);
                                        //Jika assesor 1 belum periksa dan assesor 2 != menolak dan laporan sudah upload
                                          if($fl->ketua_prodi==$this->session->userdata('nipp') && $dt1->lapor_sebagai_bkd==0 && $dt1->applaporan_ketuaprodi==0){ ?>
                                              <a href="javascript:;"
                                              ...
                                              <?php
                                                  echo anchor('Verifikator/LaporanApproved_Kaprodi/'.$dt1->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                                  echo '<br />'.wordwrap($dt1->komentar, 75, "<br />\n");
                                          //Jika assesor 2 belum periksa dan assesor 1 != menolak dan laporan sudah upload
                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt1->lapor_sebagai_bkd==0 && $dt1->applaporan_ketuaprodi==2){
                                                    echo $this->pustaka->StatusPemeriksaan($dt1->applaporan_ketuaprodi,$dt1->app_assesor1,$dt1->app_assesor2);

                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt1->lapor_sebagai_bkd==0 && $dt1->applaporan_ketuaprodi==1){
                                                    echo $this->pustaka->StatusPemeriksaan($dt1->applaporan_ketuaprodi,$dt1->app_assesor1,$dt1->app_assesor2);
                                  ...
                                  <td>
                                    <?php
                                          if($dt1->applaporan_ketuaprodi==1 && $dt1->lapor_sebagai_bkd==0){echo 'Ketua Prodi <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Ketua Prodi <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt1->app_assesor1==1 && $dt1->lapor_sebagai_bkd==1){echo 'Assesor I <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor I <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt1->app_assesor2==1 && $dt1->lapor_sebagai_bkd==1){echo 'Assesor II <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor II <span class="glyphicon glyphicon-remove"></span><br />';}
                                    ?>
                                  </td>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <?php
                                        foreach($filter as $fl);
                                        //Jika assesor 1 belum periksa dan assesor 2 != menolak dan laporan sudah upload
                                          if($fl->ketua_prodi==$this->session->userdata('nipp') && $dt2->lapor_sebagai_bkd==0 && $dt2->applaporan_ketuaprodi==0){ ?>
                                              <a href="javascript:;"
                                              ...
                                              <?php
                                                  echo anchor('Verifikator/LaporanApproved_Kaprodi/'.$dt2->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                                  echo '<br />'.wordwrap($dt2->komentar, 75, "<br />\n");
                                          //Jika assesor 2 belum periksa dan assesor 1 != menolak dan laporan sudah upload
                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt2->lapor_sebagai_bkd==0 && $dt2->applaporan_ketuaprodi==2){
                                                    echo $this->pustaka->StatusPemeriksaan($dt2->applaporan_ketuaprodi,$dt2->app_assesor1,$dt2->app_assesor2);

                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt2->lapor_sebagai_bkd==0 && $dt2->applaporan_ketuaprodi==1){
                                                    echo $this->pustaka->StatusPemeriksaan($dt2->applaporan_ketuaprodi,$dt2->app_assesor1,$dt2->app_assesor2);
                                  ...
                                  <td>
                                    <?php
                                          if($dt2->applaporan_ketuaprodi==1 && $dt2->lapor_sebagai_bkd==0){echo 'Ketua Prodi <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Ketua Prodi <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt2->app_assesor1==1 && $dt2->lapor_sebagai_bkd==1){echo 'Assesor I <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor I <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt2->app_assesor2==1 && $dt2->lapor_sebagai_bkd==1){echo 'Assesor II <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor II <span class="glyphicon glyphicon-remove"></span><br />';}
                                    ?>
                                  </td>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <?php
                                        foreach($filter as $fl);
                                        //Jika assesor 1 belum periksa dan assesor 2 != menolak dan laporan sudah upload
                                          if($fl->ketua_prodi==$this->session->userdata('nipp') && $dt3->lapor_sebagai_bkd==0 && $dt3->applaporan_ketuaprodi==0){ ?>
                                              <a href="javascript:;"
                                              ...
                                              <?php
                                                  echo anchor('Verifikator/LaporanApproved_Kaprodi/'.$dt3->id_subkegiatan."-".$this->uri->segment(3)."-"."1",'<span class="btn btn-sm btn-primary">Terima</span>');
                                                  echo '<br />'.wordwrap($dt3->komentar, 75, "<br />\n");
                                          //Jika assesor 2 belum periksa dan assesor 1 != menolak dan laporan sudah upload
                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt3->lapor_sebagai_bkd==0 && $dt3->applaporan_ketuaprodi==2){
                                                    echo $this->pustaka->StatusPemeriksaan($dt3->applaporan_ketuaprodi,$dt3->app_assesor1,$dt3->app_assesor2);

                                          }elseif($fl->ketua_prodi==$this->session->userdata('nipp') && $dt3->lapor_sebagai_bkd==0 && $dt3->applaporan_ketuaprodi==1){
                                                    echo $this->pustaka->StatusPemeriksaan($dt3->applaporan_ketuaprodi,$dt3->app_assesor1,$dt3->app_assesor2);
                                  ...
                                  <td>
                                    <?php
                                          if($dt3->applaporan_ketuaprodi==1 && $dt3->lapor_sebagai_bkd==0){echo 'Ketua Prodi <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Ketua Prodi <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt3->app_assesor1==1 && $dt3->lapor_sebagai_bkd==1){echo 'Assesor I <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor I <span class="glyphicon glyphicon-remove"></span><br />';}
                                          if($dt3->app_assesor2==1 && $dt3->lapor_sebagai_bkd==1){echo 'Assesor II <span class="glyphicon glyphicon-ok"></span><br />';}else{echo 'Assesor II <span class="glyphicon glyphicon-remove"></span><br />';}
                                    ?>
                                  </td>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="x_panel">
                          ...
                          <div class="x_content">
                            <?php
                              ...
                              if($ca->laporan_app_kaprodi==0){
                            ?>
                              <a href="<?php echo base_url() ?>Verifikator/ProdiApprovedLaporan/<?php echo $this->uri->segment(3) ?>" class="btn btn-md btn-success">Klik >> Selesai Memeriksa</a>
                            <?php }else{ ?>
                              <a href="<?php echo base_url() ?>Verifikator/ProdiResetLaporan/<?php echo $this->uri->segment(3).'/'.$ca->id_periode ?>" class="btn btn-md btn-danger">Klik >> Reset Semua Pemeriksaan</a>
                            <?php } ?>
                          </div>
                        </div>
                      </div>
   ...
   <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tolak" class="modal fade">
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <form class="form form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>Verifikator/KomentarTolakProdi">
                 ...
                 <div class="modal-body">
                         <div class="form-group">
                             ...
                             <div class="col-lg-10">
                               <textarea name="komentar_prodi" class="form-control" required="required"> </textarea>
                             </div>
                         </div>
                     </div>
